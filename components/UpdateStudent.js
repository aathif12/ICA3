...
export default function UpdateStudent({route}) {
    ...
    const [course, setCourse] = useState(student.course_name);
    ...
    const upStudent = () => {
        ...
        //navigation.popTo('Studentlist', { updateStudent});
    };
    return (
        <PaperProvider>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.input}>
                        <TextInput label="ID" mode='outlined' value={id} onChangeText={setId} disabled/>
                    </View>
                    <View style={styles.input}>
                    ...
                    {/* Apply Button */}
                    <Button mode="contained" onPress={upStudent} style={styles.applyButton}>
                        UPDATE
                    </Button>
